...
<path d="M0,854 L0,802 C60,782 130,802 190,792 C270,779 340,802 480,788 L480,854 Z" fill="${p.bush}"/>
  ...
  icon(name){
    ...
    const bodies={
      ...
      // ---- the five powers (ART_BIBLE §4.5 — these replace the text labels) ----
      slow:  `<path d="M15,9 L33,9 L33,14 C33,19 28,22 26,24 C28,26 33,29 33,34 L33,39 L15,39 L15,34 C15,29 20,26 22,24 C20,22 15,19 15,14 Z" fill="#FFFFFF" ${S}/><path d="M19,34 L29,34 L29,36 L19,36 Z" fill="#F2A33C" stroke="none"/><path d="M22,20 L26,20 L24,23 Z" fill="#F2A33C" stroke="none"/>`,
      shuffle:`<g ${S}><path d="M10,15 C20,15 24,33 38,33" fill="none"/><path d="M10,33 C20,33 24,15 38,15" fill="none"/><path d="M34,10 L41,15 L34,20 Z" fill="#FFFFFF"/><path d="M34,28 L41,33 L34,38 Z" fill="#FFFFFF"/></g>`,
