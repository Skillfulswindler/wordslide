...
/* ---- worlds -------------------------------------------------------------
   ...
   scrim     : dark veil under the board on THIS world. Measured from the real
               background art (mean luminance of the board band, art/import_bgs.py):
               blizzard is a flat white wall (lum 220) and swallows cream tiles;
               volcano is near-black (lum 74) and needs almost none. Without this,
               tiles vanish on snow.
...
WS.WORLDS = {
  mudslide: { key:"mudslide", scrim:0.15, name:"Mudslide", order:1, sub:"Slow & sticky. Learn the ropes.", unlock:0,
  ...
  landslide:{ key:"landslide", scrim:0.3, name:"Landslide", order:2, sub:"Boulders block the board — crack them with words.", unlock:300,
  ...
  avalanche:{ key:"avalanche", scrim:0.3, name:"Avalanche", order:3, sub:"Letters arrive in sudden bursts.", unlock:450,
  ...
  volcano:  { key:"volcano", scrim:0.14, name:"Volcano", order:4, sub:"Ember letters burn away if not played fast.", unlock:600,
  ...
  sandstorm:{ key:"sandstorm", scrim:0.24, name:"Sandstorm", order:5, sub:"Gusts scramble your tray.", unlock:750,
  ...
  waterfall:{ key:"waterfall", scrim:0.23, name:"Waterfall", order:6, sub:"A constant, relentless flow.", unlock:900,
  ...
  blizzard: { key:"blizzard", scrim:0.44, name:"Blizzard", order:7, sub:"Frost hides your letters.", unlock:1050,
